...
public class RouletteController {
    ...
    @Operation(summary = "룰렛 지분 조회", description = "멤버별 totalPoints 기반으로 룰렛 칸 비율을 반환합니다.")
    @GetMapping("/slices")
    public CommonResponse<List<RouletteSliceResponse>> getSlices() {
        return CommonResponse.success(rouletteService.getSlices());
    }
    ...
    public CommonResponse<List<RouletteResultResponse>> getResults(
        ...
        return CommonResponse.success(rouletteService.getResults(nextWeekStartDate));
    }
}
